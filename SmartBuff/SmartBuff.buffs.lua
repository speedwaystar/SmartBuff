...
function SMARTBUFF_InitSpellList()
  ...
  -- FOOD
  SMARTBUFF_FOOD = {
    {SMARTBUFF_SALTPEPPERSHANK, 30, SMARTBUFF_CONST_FOOD},
    {SMARTBUFF_PICKLEDSTORMRAY, 30, SMARTBUFF_CONST_FOOD},
    {SMARTBUFF_DROGBARSTYLESALMON, 30, SMARTBUFF_CONST_FOOD},
    {SMARTBUFF_BARRACUDAMRGLGAGH, 30, SMARTBUFF_CONST_FOOD},
    {SMARTBUFF_FIGHTERCHOW, 30, SMARTBUFF_CONST_FOOD},
    {SMARTBUFF_FARONAARFIZZ, 30, SMARTBUFF_CONST_FOOD},
    {SMARTBUFF_BEARTARTARE, 30, SMARTBUFF_CONST_FOOD},
    {SMARTBUFF_LEGIONCHILI, 30, SMARTBUFF_CONST_FOOD},
    {SMARTBUFF_DEEPFRIEDMOSSGILL, 30, SMARTBUFF_CONST_FOOD},
